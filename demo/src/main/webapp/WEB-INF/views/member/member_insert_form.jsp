...
<form class="form-inline">
  <div id="box">
      ...
      <div class="panel-body">
            ...
            <div class="seperator">
                <label>충전타입 : </label>
                <input type="radio" name="mem_type" value="AC5pin"/>AC 단상 (5핀)&nbsp;
                <br>
                <input type="radio" name="mem_type" value="AC7pin"/>AC 3상 (7핀)&nbsp;
                <br>
                <input type="radio" name="mem_type" value="DCcombo"/>DC 콤보 (CCS)&nbsp;
                <br>
                <input type="radio" name="mem_type" value="CHAdeMO"/>차데모, CHAdeMO&nbsp;
                <br>
                <input type="radio" name="mem_type" value="NACS"/>테슬라 NACS&nbsp;
