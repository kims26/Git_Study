...
<body>
    ...
    <div id="box">
        ...
        <!-- 글쓰기 -->
        <div style="position: relative; margin-top: 15px; margin-bottom: 55px; text-align: right;">
        ...
        <table class="table">
            ...
            <tr>
                <td colspan="5" align="center">
                   ...
                   <input type="text" class="form-control" id="search_text" value="${param.search_text}" onkeyup="enterkey(e)">
