    ...
    function confirmNumber(){
        ...
        function check_id(){
            ...
            if(o_id.length<3){
                ...
                //회원가입버튼 비활성화
                $("#btn_ver btn_ver1").attr("disabled",true);//비활성화
            ...
            data		:	{"o_id" : o_id },	//parameter=>check_id.do?mem_id=hong
            dataType	:	"json",
			...
			<form  class="form-inline"  id="createform" name="form1" method="GET">
				...
				<section class="section02 section">
					...
					<div class="form_box">
						...
						<fieldset>
                            ...
                            <label for="user_pw_n1" class="input_box shop_name">
                                ...
                                <input type="name" name="o_email" id="o_email" class="input_text"  placeholder="이메일을 입력해주세요."  />
                            </label>
								...
								<div class="address_line address_line01 user_b">
									...
									<button type="button" class="user_btn" onclick="check_id();">중복체크</button>
								</div>
					...
					<div class="btn_ver1_box f_c">
                        ...
                        <input class="btn_ver btn_ver1" type="button" value="프리미엄 회원가입" onclick="send(this.form);">
					</div>
				</section>
			</form>
        </div>
